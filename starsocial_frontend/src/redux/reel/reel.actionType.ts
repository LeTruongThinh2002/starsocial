...
export const GET_USER_REEL_REQUEST = "GET_USER_REEL_REQUEST";
export const GET_USER_REEL_SUCCESS = "GET_USER_REEL_SUCCESS";
export const GET_USER_REEL_FAILURE = "GET_USER_REEL_FAILURE";
