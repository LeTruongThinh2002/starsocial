  ...
  return (
    ...
    >
      <CardHeader
          ...
          <>
            ...
            user.id === post.user.id ? (
              ...
              <span
                ...
                className="text-sky-300 hover:text-sky-600 cursor-pointer text-sm font-bold"
              >
                {"- "}
                Follow
              </span>
        ...
        subheaderTypographyProps={{ color: "rgba(255, 255, 255, 0.9)" }}
        ...
        <div className="flex flex-row w-full">
          ...
          >
            {user.savedPost?.some(
              ...
              <BookmarkAddedRoundedIcon sx={{ color: "yellow" }} />
            ) : (
              <BookmarkBorderRoundedIcon />
            )}
          </IconButton>
        </div>
        <div className="flex ml-[1.3rem] gap-2 text-sm text-white opacity-90 w-full">
          <span>{post.liked.length} stars</span>
      ...
      {showComments && (
        <section>
          <div className="flex items-center space-x-5 mx-3 my-2">
            ...
            <input
              type="text"
              className="w-full outline-none input-placeholder-style bg-transparent text-white border border-white rounded-full px-5 py-2"
                ...
                <div key={cmt.id} className="flex items-center space-x-5">
                  ...
                  <div className="flex flex-col">
                    <div className="flex flex-row gap-2">
                      <h4 className="cursor-pointer font-bold hover:text-yellow-300">
